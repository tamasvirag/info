(function($) {
    $(function() {
        ...
        // nav export
        $(document).on('click', '.btn-nav-export', function() {
            $("#search-destination").val('xml');
            $("#search-invoice").submit();
        });
        $(document).on('click', '.btn-nav-submit', function() {
            $("#search-destination").val('screen');
            $("#search-invoice").submit();
        });
